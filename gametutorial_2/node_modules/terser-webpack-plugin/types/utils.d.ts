...
export type ExtractCommentsOptions =
  import("terser-webpack-plugin/types").ExtractCommentsOptions;
export type ExtractCommentsFunction =
  import("terser-webpack-plugin/types").ExtractCommentsFunction;
export type ExtractCommentsCondition =
  import("terser-webpack-plugin/types").ExtractCommentsCondition;
export type Input = import("terser-webpack-plugin/types").Input;
export type MinimizedResult = import("terser-webpack-plugin/types").MinimizedResult;
export type PredefinedOptions = import("terser-webpack-plugin/types").PredefinedOptions;
