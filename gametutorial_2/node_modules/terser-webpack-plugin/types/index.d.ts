...
export type TerserECMA = import("terser-webpack-plugin/types/utils").TerserECMA;
export type TerserOptions = import("terser-webpack-plugin/types/utils").TerserOptions;
export type CustomOptions = import("terser-webpack-plugin/types/utils").CustomOptions;
...
export type InferDefaultType<T> = T extends infer U
  ? U
  : import("terser-webpack-plugin/types/utils").CustomOptions;
