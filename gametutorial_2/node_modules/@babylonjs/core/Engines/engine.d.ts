...
import { ICustomAnimationFrameRequester } from '@babylonjs/core/Misc/customAnimationFrameRequester';
...
export declare class Engine extends ThinEngine {
     ...
     */
    postProcesses: import("@babylonjs/core/PostProcesses/postProcess").PostProcess[];
    /**
