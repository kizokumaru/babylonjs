import { IInternalTextureLoader } from '@babylonjs/core/Materials/Textures/internalTextureLoader';
...
import { Nullable, DataArray, IndicesArray } from '@babylonjs/core/types';
...
import { IViewportLike, IColor4Like } from '@babylonjs/core/Maths/math.like';
...
declare type WebRequest = import("@babylonjs/core/Misc/webRequest").WebRequest;
declare type LoadFileError = import("@babylonjs/core/Misc/fileTools").LoadFileError;
/**
...
export declare class ThinEngine {
     ...
     */
    onBeforeTextureInitObservable: Observable<import("@babylonjs/core/Materials/Textures/texture").Texture>;
    /**
