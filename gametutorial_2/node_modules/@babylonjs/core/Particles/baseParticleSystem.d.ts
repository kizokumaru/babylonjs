...
import { ImageProcessingConfiguration, ImageProcessingConfigurationDefines } from "@babylonjs/core/Materials/imageProcessingConfiguration";
import { ColorGradient, FactorGradient, Color3Gradient, IValueGradient } from "@babylonjs/core/Misc/gradients";
import { BoxParticleEmitter, IParticleEmitterType, PointParticleEmitter, HemisphericParticleEmitter, SphereParticleEmitter, SphereDirectedParticleEmitter, CylinderParticleEmitter, CylinderDirectedParticleEmitter, ConeParticleEmitter } from "@babylonjs/core/Particles/EmitterTypes";
...
declare type ProceduralTexture = import("@babylonjs/core/Materials/Textures/Procedurals/proceduralTexture").ProceduralTexture;
declare type RawTexture = import("@babylonjs/core/Materials/Textures/rawTexture").RawTexture;
/**
